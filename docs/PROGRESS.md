...
**Current focus:** Phase 3, Step 3.5 — kind e2e (bookinfo → plan → rollout → verify).
...
| 3.5 | kind e2e: bookinfo → plan → rollout → verify | ⬜ | `cursor/e2e-kind-ambient` | CI job; Phase 3 exit criteria |
