    ...
    pub async fn list_applications(
        ...
        let total: (i64,) = sqlx::query_as(
            ...
            WHERE c.cluster_ref = $1
              ...
              AND ($2::text IS NULL OR aa.namespace ILIKE $2 OR aa.hostnames::text ILIKE $2)
...
async fn insert_application(
    ...
    sqlx::query(
        ...
        INSERT INTO application_assessments (
            id, run_id, cluster_id, namespace, mesh_revision, discovery_label,
